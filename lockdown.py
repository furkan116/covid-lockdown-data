...
class LockDown(object):
    def __init__(self, country_code, lockdown_start_date, lockdown_end_date):
        ...
        self.lockdown_start_date = lockdown_start_date
        self.lockdown_start_date_datetime_object = datetime.datetime.strptime(self.lockdown_start_date, '%d.%m.%Y')
        self.lockdown_end_date = lockdown_end_date
        self.lockdown_end_date_datetime_object = datetime.datetime.strptime(self.lockdown_end_date, '%d.%m.%Y')
        self.dataframe = None
